...
const Data = [
  {
    id: 'What does HTML stand for?L',
    category: 'HTML',
    question: 'What does HTML stand for?',
    postedby:"Anonymous",
    answer: [{content:'HTML stands for HyperText Markup Language.',postedby:"Anonymous"}],
    
  },
  {
    id: 'How do you create a form in HTML?',
    category: 'HTML',
    question: 'How do you create a form in HTML?',
    postedby:"Anonymous",
    answer: [{content:'Use the <form> element to create a form and include various form controls like input, select, textarea, etc.',postedby:"Anonymous"}],
  ...
  },
  {
    ...
    question: 'Explain the CSS Box Model.',
    postedby:"Anonymous",
    answer: [{content:'The CSS Box Model describes the design and layout of elements on a web page, comprising content, padding, border, and margin.',postedby:"Anonymous"}],
    
  },
  {
    id: 'What is Flexbox and how does it work?',
    category: 'CSS',
    question: 'What is Flexbox and how does it work?',
    postedby:"Anonymous",
    answer: [{content:'Flexbox is a layout model in CSS that allows for flexible and efficient design of containers and their items in a one-dimensional layout.',postedby:"Anonymous"}],
  ...
  {
    id: 'What are the different ways to declare variables in JavaScript?',
    category: 'JavaScript',
    question: 'What are the different ways to declare variables in JavaScript?',
    postedby:"Anonymous",
    answer: [{content:'Variables can be declared using var, let, or const keywords.',postedby:"Anonymous"}],
    
  },
  {
    id: 'How do you define functions in JavaScript?',
    category: 'JavaScript',
    question: 'How do you define functions in JavaScript?',
    postedby:"Anonymous",
    answer: [{content:'Functions can be defined using the function keyword or arrow functions (=>).',postedby:"Anonymous"}],
    
  },
  {
    id: 'How do you create components in React?',
    category: 'React.js',
    question: 'How do you create components in React?',
    postedby:"Anonymous",
    answer: [{content:'Components can be created as functional components using arrow functions or as class components extending React.Component.',postedby:"Anonymous"}],
  ...
  },
  {
    ...
    question: 'HTML',
    postedby:"Anonymous",
    answer: [{content:'Props (short for properties) are a way to pass data from parent to child components in React.',postedby:"Anonymous"}],
    
  },
  {
    id: 'What is Angular CLI?',
    category: 'Angular',
    question: 'What is Angular CLI?',
    postedby:"Anonymous",
    answer: [{content:'Angular Modules are containers for a cohesive block of code dedicated to an application domain, workflow, or closely related set of capabilities. They help organize the application into cohesive blocks of functionality.',postedby:"Anonymous"}],
    
  },
  {
    id: 'What are Angular Components?',
    category: 'Angular',
    question: 'What are Angular Components?',
    postedby:"Anonymous",
    answer: [{content:'Angular Components are the fundamental building blocks of Angular applications. They are responsible for handling data, rendering views, and responding to user input.',postedby:"Anonymous"}],
